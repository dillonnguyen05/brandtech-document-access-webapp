...
/**
 * Creates an HTTP error for middleware before the route files are reached.
 */
function createServerError(status, message) {
...
app.use(cors({
  origin(origin, callback) {
    ...
    callback(createServerError(403, "Origin is not allowed by CORS."));
  }
}));
